...
// This program, Nutrient App, is free software: you can redistribute it and/or modify
...
//        res_rgb[i][8] = res_rgb_PO4_9[i];
    ...
    // Process image
    // Riya: the python interface should retrieve the arguments of ProcImag
    // this code should replace part of the variable initiation above
    // test if Riya can commit and post in slack
